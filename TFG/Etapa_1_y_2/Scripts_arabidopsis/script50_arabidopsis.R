...
df50 <- data.frame(matrix(ncol=4, nrow=length(peaks$V1)))
...
texto50 <- paste0("/sequence/region/arabidopsis_thaliana/", df50$Cromosoma50, ":", df50$Coordenada_inicial50, "..", df50$Coordenada_final50, ":1?")
...
writeLines(fasta, "secuencias50_ZAT10_JA.fasta")